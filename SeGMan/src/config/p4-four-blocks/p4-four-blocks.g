...
obj1(obj1Joint) {
    shape:ssBox, Q:[-1.2 -0.3 .0], size:[1 0.2 .2 .02], logical={ object } nomass:1,  color:[1 1 1],
...
obj3(obj3Joint) {
    shape:ssBox, Q:[-0.4 -1.4 .0], size:[.2 1 .2 .02], logical={ object } nomass:1,  color:[1 1 1.0],
    joint:rigid, friction:.1  contact: 1
}

obj4Joint(world){ Q:[0.0 0.0 0.1] } # works
obj4(obj4Joint) {
    shape:ssBox, Q:[-1.4 -0.75 .0], size:[1 0.2 .2 .02], logical={ object } nomass:1,  color:[1.0 1 1],
    joint:rigid, friction:.1  contact: 1
}
