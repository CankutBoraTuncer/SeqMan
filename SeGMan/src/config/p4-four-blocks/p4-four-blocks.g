...
obj1(floor) {
    shape:ssBox, Q:[-1.2 -0.3 .15], size:[1 0.2 .2 .02], logical={ object } nomass:1,  color:[0 0 1.0],
    joint:rigid, friction:.1  contact: 1
}

obj2(floor) {
    shape:ssBox, Q:[-0.75 -1.2 .15], size:[.2 1 .2 .02], logical={ object } nomass:1,  color:[0 1.0 0],
    joint:rigid, friction:.1  contact: 1
}

obj3(floor) {
    shape:ssBox, Q:[-0.4 -1.4 .15], size:[.2 1 .2 .02], logical={ object } nomass:1,  color:[0 1.0 1.0],
    joint:rigid, friction:.1  contact: 1
}


obj4(floor) {
    shape:ssBox, Q:[-1.4 -0.75 .15], size:[1 0.2 .2 .02], logical={ object } nomass:1,  color:[1.0 0 0],
    joint:rigid, friction:.1  contact: 1
}
