...
block_5_4 (floor) 	{  Q:[-0.2, -1.2, 0.2, -1, 0, 0, 0], shape:ssBox, size:[0.4, 1.6, 0.4, 0.01], color:[0.6953, 0.515625, 0.453125], contact:1, mass:100, inertia:[0 0 0] }
...
objJoint (world) 	{  Q:[0, 0, 0.1] }
obj (objJoint) 	{  Q:[-0.65, -1, 0], joint:rigid, shape:ssBox, size:[0.2, 0.2, 0.2, 0.02], color:[0, 0, 1], contact:1, mass:100, inertia:[0 0 0], logical:{ object } }

#---------------------------------------------------------------------------------------------------#

obj1Joint (world) 	{  Q:[0, 0, 0.1] }
obj1 (obj1Joint) 	{  Q:[-1, -1, 0], joint:rigid, shape:ssBox, size:[0.2, 0.2, 0.2, 0.02], color:[1, 1, 1], contact:1, mass:100, inertia:[0 0 0], logical:{ object } }

#---------------------------------------------------------------------------------------------------#

obj2Joint (world) 	{  Q:[0, 0, 0.1] }
obj2 (obj2Joint) 	{  Q:[-0.6, 0.2, 0], joint:rigid, shape:ssBox, size:[0.2, 0.2, 0.2, 0.02], color:[1, 1, 1], contact:1, mass:100, inertia:[0 0 0], logical:{ object } }

#---------------------------------------------------------------------------------------------------#

obj3Joint (world) 	{  Q:[0, 0, 0.1] }
obj3 (obj3Joint) 	{  Q:[-1, -1.8, 0], joint:rigid, shape:ssBox, size:[0.2, 0.2, 0.2, 0.02], color:[1, 1, 1], contact:1, mass:100, inertia:[0 0 0], logical:{ object } }
