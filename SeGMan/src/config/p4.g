...
obj3(obj3Joint) {
    shape:ssBox, Q:[-0.4 1.4 .0], size:[.2 1 .2 .02], logical={ object } nomass:1,  color:[0 0 1.0],
    joint:rigid, friction:.1  contact: 1
}
...
obj5(obj4Joint) {
    shape:ssBox, Q:[-0.9 0.0 .0], size:[1 0.2 .2 .02], logical={ object } nomass:1,  color:[0.5 0 1],
    joint:rigid, friction:.1  contact: 1
}

obj6Joint(world){ Q:[0.0 0.0 0.1] } # works
obj6(obj6Joint) {
    shape:ssBox, Q:[0. 0.0 .0], size:[0.4 0.2 .2 .02], logical={ object } nomass:1,  color:[0.5 0.5 1],
    joint:rigid, friction:.1  contact: 1
}

obj7Joint(world){ Q:[0.0 0.0 0.1] } # works
obj7(obj7Joint) {
    shape:ssBox, Q:[1.5 1.0 .0], size:[0.2 0.2 .2 .02], logical={ object } nomass:1,  color:[0.75 0.25 1],
    joint:rigid, friction:.1  contact: 1
}

obj8Joint(world){ Q:[0.0 0.0 0.1] } # works
obj8(obj8Joint) {
    shape:ssBox, Q:[1.2 -1.4 .0], size:[0.2 0.2 .2 .02], logical={ object } nomass:1,  color:[0 0 0],
    joint:rigid, friction:.1  contact: 1
}
