...
ego(egoJoint) {
    shape:ssCylinder, Q:[1.5 0.0 0], size:[.2 .2 .02], color:[0.96875 0.7421875 0.30859375], logical:{gripper}, limits: [-4 4 -4 4], sampleUniform:1,
...
obj(objJoint) { type:ssBox size:[.3 .3 .2 .02] Q:"t(1.6 -1.6  0)" color:[0 0 1],  logical={ object }, joint:rigid, contact: 1 }
