...
obj1 (obj1Joint) 	{  Q:[-1, -1, 0], joint:rigid, shape:ssBox, size:[0.2, 0.2, 0.2, 0.02], color:[1, 0, 0], contact:1, mass:100, inertia:[0 0 0], logical:{ object } }

#---------------------------------------------------------------------------------------------------#

obj2Joint (world) 	{  Q:[0, 0, 0.1] }
obj2 (obj2Joint) 	{  Q:[-0.6, 0.2, 0], joint:rigid, shape:ssBox, size:[0.2, 0.2, 0.2, 0.02], color:[0, 1, 0], contact:1, mass:100, inertia:[0 0 0], logical:{ object } }

#---------------------------------------------------------------------------------------------------#

obj3Joint (world) 	{  Q:[0, 0, 0.1] }
obj3 (obj3Joint) 	{  Q:[-1, -1.8, 0], joint:rigid, shape:ssBox, size:[0.2, 0.2, 0.2, 0.02], color:[0, 0, 1], contact:1, mass:100, inertia:[0 0 0], logical:{ object } }
